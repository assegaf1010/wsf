...
<div class="flex h-full ">
    ...
    <div class="flex-1 px-12  space-y-6">
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex items-center gap-4">
          <input type="text" class="p-2 border rounded w-60" placeholder="Cari sesuatu...">
          <button class="p-2 bg-blue-600 text-white rounded">Cari</button>
        </div>
      </div>
    ...
    <section class="flex space-x-10">
      ...
      <div class="bg-white p-6 rounded-3xl shadow w-3/6 min-w-40">
        ...
        @endforeach
          <a href="/pengumumanadmin" class="text-blue-500 font-medium ">Lihat semua Pengumuman</a>
        </ul>
      </div>
